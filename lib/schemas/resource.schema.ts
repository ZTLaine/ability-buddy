...
export const createResourceSchema = z.object({
  ...
  bodySystems: z.array(z.string().min(1, "Body system cannot be empty").max(50, "Body system must be at most 50 characters long")).max(10, "Maximum of 10 body systems allowed").optional(),
